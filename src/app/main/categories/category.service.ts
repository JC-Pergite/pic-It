...
export class CategoryService {
  ...
  private currentSubject: BehaviorSubject<any> = new BehaviorSubject<Category[]>([]);
 ...
 setTrending(trends) { 
    ...
    if(this.trending.length <= 4 && trends.likes.likes > this.coolLimiterSubject.value) { 
